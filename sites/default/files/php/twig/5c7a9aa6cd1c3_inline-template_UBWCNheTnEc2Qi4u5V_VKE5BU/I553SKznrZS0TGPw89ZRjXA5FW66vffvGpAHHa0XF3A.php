...
/* {# inline_template_start #}{{ created }} {{ comment_count }} */
class __TwigTemplate_c0714190a8c381dc1e1071cafef2fc5ec81e4bd60b52f1d818e16c5c337360b0 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}{{ created }} {{ comment_count }}";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}{{ created }} {{ comment_count }}", "");
    }
}
